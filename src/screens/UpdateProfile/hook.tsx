...
export default function Hook(props?: Props) {
  ...
  const [lookingFor, setLookingFor] =
    useState<string>(item ? item.looking_for : '')
  ...
  const setRelationshipHandler = (
    value: string
  ) => {
    setRelationship(value)
  }
  const setLookingForHandler = (
    value: string
  ) => {
    setLookingFor(value)
  }
